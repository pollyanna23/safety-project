...
public class ConstructionSafetyRule extends DefaultRule {
    ...
    private static class ConstructionSafetyToolsPanel extends ConstraintToolsPanel {
        private static final long serialVersionUID = 1L;
        ...
        private ConstructionSafetyToolsPanel() {
            ...
            panel1.setBorder(BorderFactory.createTitledBorder("Safety Rule Visualization")); 
