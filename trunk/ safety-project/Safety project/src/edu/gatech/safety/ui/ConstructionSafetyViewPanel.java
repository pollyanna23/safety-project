...
public class ConstructionSafetyViewPanel extends ViewPanel implements
	...
	JButton S_open, S_run, S_test, Btn_others;
	...
	public ConstructionSafetyViewPanel(IView view) {
		...
		tabbedPane
				.setToolTipTextAt(
						0,
						new String(
								"<html>This module has been developed by Georgia Tech, jklee@gatech.edu.</html>"));
		// tabbedPane.setToolTipTextAt(2, new
		// String("<html>This module is under development.</html>"));
		// Disable tabs TODO
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == S_open) {
			...
			JOptionPane.showMessageDialog(null, "This is a test button.",
